 ...
 * @param order_id
 */
function wap_pay(channel,user_id) {
	
    var amount = document.getElementById('amount').value * 100;
    var xhr = new XMLHttpRequest();
    xhr.open("POST",share.data("address")+"/htmlWalletcharge?Html_Acc="+share.data("acc")+"&Html_Pass="+share.data("pass")+"&user_id="+user_id+"&amount="+amount, true);
