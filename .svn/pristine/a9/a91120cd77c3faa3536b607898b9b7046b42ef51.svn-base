...
///// DELETE SELECTED ROW IN A TABLE /////
	jQuery('.deletebutton').click(function(){
		...
		var tb = jQuery(this).attr('deleteforcheck');							// get target id of table								   
		var method = jQuery(this).attr('method');							// 实际调用的方法								   
